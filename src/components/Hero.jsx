      ...
      <div className="container-flex">
        <div className="box-flex">
          ...
          <p className="text">
            ...
            quam repellendus iusto laboriosam veniam iste aliquid accusantium
            animi facilis laborum tempore maiores sequi fugit.
          </p>
          <a className="button button-circle" href="#">
            More
          </a>
        </div>
        <div className="box-flex">
